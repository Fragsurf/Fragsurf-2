...
namespace RealtimeCSG
{
	internal static class ColorSettings
	{
		...
		static Color vertexPoint = new Color(1.0f, 1.0f, 1.0f, 1.0f);
		public static Color VertexPoint { get { return vertexPoint; } }
		...
		public static void Update()
		{
			...
			meshEdgeOutline = Color.white;  
			meshEdgeOutline.a = Mathf.Max(0.9f, meshEdgeOutline.a);
