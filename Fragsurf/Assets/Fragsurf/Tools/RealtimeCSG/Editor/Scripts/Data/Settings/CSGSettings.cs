...
namespace RealtimeCSG
{
    ...
    public static class CSGSettings
    {
        public static string RootAssetPath
        {
            get
            {
                ...
                var prefix = AssetDatabase.LoadAssetAtPath($"Packages/{pkgName}/UnityPackage/Fragsurf/candy.txt", typeof(TextAsset)) != null
                    ...
                    : "Assets";
                return prefix + "/Fragsurf/Tools/RealtimeCSG";
            }
        }
        ...
        {
            if (!sceneViewLookup.TryGetValue(camera, out SceneView sceneView))
            {
                return false;
            }
        ...
        internal static void UpdateWireframeModes()
        {
            ...
            {
                if (IsWireframeShown(sceneView) && EnableRealtimeCSG)
                {
        ...
        public static bool ScaleSnapping => ActiveSnappingMode != SnapMode.None;
        public static bool RotationSnapping => ActiveSnappingMode != SnapMode.None;
        public static bool GridSnapping => ActiveSnappingMode == SnapMode.GridSnapping;
        public static bool RelativeSnapping => ActiveSnappingMode == SnapMode.RelativeSnapping;

        private static Vector3 _snapVector = MathConstants.oneVector3;
        public static Vector3 SnapVector
        {
            get => _snapVector;
            set
            {
                ...
                for(int i = 0; i < 3; i++)
                {
                    _snapVector[i] = Mathf.Clamp(_snapVector[i], .0254f, 13.0048f);
                }
            }
        }
        ...
        static public DistanceUnit DistanceUnit = DistanceUnit.Inches;
