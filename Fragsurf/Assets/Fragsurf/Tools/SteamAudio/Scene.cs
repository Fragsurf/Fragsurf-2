...
//#endif
                ...
                else
                {
                    ...
                    SteamAudioManager.GetSingleton().sceneData = data;
        ...
        public Error Build(ComputeDevice computeDevice, MaterialValue defaultMaterial,
            IntPtr globalContext, out byte[] data)
        {
            data = null;
        ...
        public Error Create(byte[] data, ComputeDevice computeDevice, SimulationSettings simulationSettings, IntPtr globalContext)
        {
