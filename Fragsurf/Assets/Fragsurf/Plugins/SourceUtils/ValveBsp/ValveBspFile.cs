...
namespace SourceUtils
{
    public partial class ValveBspFile : DisposingEventTarget<ValveBspFile>
    {
        ...
        [BspLump(LumpType.LEAFBRUSHES)]
        public StructArrayLump<ushort> LeafBrushes { get; private set; }

        [BspLump(LumpType.FACES)]
        public StructArrayLump<Face> Faces { get; private set; }

        [BspLump(LumpType.ORIGINALFACES)]
        public StructArrayLump<Face> OriginalFaces { get; private set; }
