...
namespace Chisel.Editors
{
    internal sealed partial class ChiselMaterialBrowserWindow
    {
        ...
        private string ApplyLastMaterialShortcut => ShortcutManager.instance.GetShortcutBinding("Realtime-CSG/Material Browser/Apply Last Selected Material").ToString();
